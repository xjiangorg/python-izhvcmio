...
export IMAGE_URL=${IMAGE_URL-nexus-docker-nexus.apps.rosa.rhtap-services.xmdt.p3.openshiftapps.com/rhtap/python-izhvcmio:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/xjiangorg/python-izhvcmio-gitops
